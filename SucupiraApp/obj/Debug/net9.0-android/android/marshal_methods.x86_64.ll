...
@assembly_image_cache_hashes = dso_local local_unnamed_addr constant [945 x i64] [
	...
	i64 u0x15218a41f26ce890, ; 81: SucupiraApp => 0
	...
	i64 u0x36263608556d5d42, ; 203: Npgsql.dll => 189
	...
	i64 u0x99a00ca5270c6878, ; 564: Xamarin.AndroidX.Navigation.Runtime => 245
	i64 u0x99cdc6d1f2d3a72f, ; 565: ko/Microsoft.Maui.Controls.resources.dll => 296
	i64 u0x9a01b1da98b6ee10, ; 566: Xamarin.AndroidX.Lifecycle.Runtime.dll => 233
	i64 u0x9a5ccc274fd6e6ee, ; 567: Jsr305Binding.dll => 267
	i64 u0x9acfd25e735d5594, ; 568: lib_Npgsql.dll.so => 189
	...
	i64 u0xa1440773ee9d341e, ; 591: Xamarin.Google.Android.Material => 266
	i64 u0xa1b9d7c27f47219f, ; 592: Xamarin.AndroidX.Navigation.UI.dll => 246
	...
	i64 u0xa4145becdee3dc4f, ; 598: Xamarin.AndroidX.VectorDrawable.Animated => 260
	i64 u0xa46aa1eaa214539b, ; 599: ko/Microsoft.Maui.Controls.resources => 296
	i64 u0xa4d3c85d8f39d8b4, ; 600: SucupiraApp.dll => 0
	...
	i64 u0xa54b550b9a8bb86e, ; 603: lib_SucupiraApp.dll.so => 0
	...
	i64 u0xf79cbf52994c8548, ; 905: Npgsql => 189
...
@assembly_image_cache_indices = dso_local local_unnamed_addr constant [945 x i32] [
	...
	i32 207, i32 0, i32 4, i32 5, i32 51, i32 101, i32 56, i32 120,
	...
	i32 253, i32 47, i32 30, i32 246, i32 296, i32 144, i32 182, i32 163,
	i32 28, i32 84, i32 257, i32 77, i32 43, i32 29, i32 42, i32 103,
	i32 117, i32 197, i32 45, i32 91, i32 307, i32 56, i32 148, i32 146,
	i32 100, i32 49, i32 20, i32 212, i32 114, i32 190, i32 288, i32 268,
	i32 272, i32 183, i32 94, i32 58, i32 293, i32 291, i32 81, i32 268,
	...
	i32 76, i32 55, i32 186, i32 282, i32 184, i32 13, i32 263, i32 175,
	i32 201, i32 109, i32 239, i32 189, i32 32, i32 104, i32 84, i32 92,
	...
	i32 105, i32 239, i32 184, i32 111, i32 198, i32 49, i32 20, i32 238,
	...
	i32 188, i32 15, i32 183, i32 79, i32 79, i32 214, i32 183, i32 217,
	i32 244, i32 252, i32 152, i32 21, i32 186, i32 282, i32 50, i32 51,
	...
	i32 271, i32 297, i32 83, i32 181, i32 12, i32 34, i32 119, i32 278,
	...
	i32 113, i32 205, i32 259, i32 258, i32 37, i32 313, i32 175, i32 115,
	...
	i32 42, i32 278, i32 33, i32 314, i32 46, i32 143, i32 238, i32 185,
	...
	i32 189, i32 264, i32 150, i32 142, i32 276, i32 273, i32 126, i32 275,
	i32 160, i32 162, i32 216, i32 194, i32 176, i32 299, i32 26, i32 243,
	i32 230, i32 82, i32 264, i32 127, i32 268, i32 101, i32 148, i32 266,
	i32 246, i32 54, i32 162, i32 167, i32 131, i32 37, i32 260, i32 296,
	i32 0, i32 22, i32 112, i32 0, i32 90, i32 217, i32 50, i32 60,
	...
	i32 284, i32 189, i32 83, i32 311, i32 309, i32 61, i32 96, i32 249,
